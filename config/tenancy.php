...
return [
    ...
    'database' => [
        ...
        'managers' => [
            ...
            /**
             * ADR-0001: separate tenants by Postgres schema (not by database).
             */
    ...
    'filesystem' => [
        ...
        /**
         * Disabled: our Vite build (resources/js, the SPA shell) is shared across every
         * tenant and lives in public/build, not per-tenant storage. If this were true,
         *
         * @vite()'s asset() calls would get rewritten to /tenancy/assets/... and 404.
         * Genuinely tenant-specific files (school logos, student photos) should use
         * tenant_asset() explicitly instead.
         */
